...
5. i-band 대화형 영상에서 **은하의 장축 방향 경계점과 단축 방향 경계점을 마우스로 각각 한 번 클릭**합니다. 장축 반경·단축 반경·위치각은 자동 계산됩니다.
6. 잘못 클릭했다면 그림에서 **오른쪽 클릭**으로 초기화한 뒤 다시 선택합니다.
7. 분석이 끝나면 결과 CSV/JPG를 ZIP으로 내려받을 수 있습니다.
